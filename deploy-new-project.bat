@echo off
echo ===== Script de Deploy para Vercel (Novo Projeto) =====
...
echo   "name": "brokerbooster-api-new",>> temp-deploy\package.json
...
:: Deploy sem vincular ao projeto existente
npx vercel --name brokerbooster-new --prod
